  ...
  if($name && $email && $message) {
    ...
    if ($words > 2) {
      ...
      try { 
          ...
          //Recipients
          $mail->setFrom(EMAIL, 'MotherfuckingBob.com');
          $mail->addAddress(EMAIL, 'MotherfuckingBob.com Website');     // Add a recipient
          ...
          // Content
          $mail->isHTML(true);
          $mail->Subject = 'Email from MotherfuckingBob.com Website';
