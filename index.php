...
<head>
    ...
    <title>Of course I bought this one too!</title>
    <link rel="icon" type="image/ico" href="_images/favicon.ico">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <meta name="description" content="What, you didn't think I bought this one too, did you?">
    <meta name="format-detection" content="telephone=no">

    <meta property="og:url" content="http://www.motherfuckingbob.com" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Of course I bought this one too!" />
    <meta property="og:image" content="http://www.motherfuckingbob.com/_images/motherfucking-bob.jpg?<?php echo time(); ?>" />
    <meta property="og:image:alt" content="Motherfucking Bob" />
    <meta property="og:description" content="What, you didn't think I bought this one too, did you?" />
    ...
    <!-- Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140046709-3"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-140046709-3');
    </script>
...
<div id="wrapper">
    ...
    <?php
        ...
        $fields_string = '';
        $fields = array(
            'secret' => '6LcWIKMUAAAAAJRUkqHh-ngGZOs8KNDMN1eQSx7-',
    ...
    <?php
        ...
        $subject = "Message From MotherfuckingBob.com Website";
...
<div id="contact-wrapper" class="cf">
        <img class="click-box-01 bob-twirl" src="_images/motherfucking-bob.jpg">
        ...
        <div id="box-01" class="foo">
            <form action="" method="post" id="contactForm" onSubmit="return validateEmail(document.forms[0].email.value);">  
                ...
                <ul>
                  ...
                  <li>
                    <div class="g-recaptcha" data-theme="dark" data-callback="recaptchaCallback" data-sitekey="6LcWIKMUAAAAABk8-rvTToRHrot0wvOgpenXgs3o"></div>
                  </li>
                  <li>
